...
export default function Skills() {
   ...
   const Progress = ({done}) => {
        ...
        return (
            ...
            variants={skillsB1Anime} initial='initial' animate='animate'>
             <h1> Frond End</h1>
                <h3 > HTML </h3>
		        <Progress done="99"/>
                <h3> CSS </h3>
            ...
            <motion.div className='skills_box' variants={skillsB2Anime} initial='initial' animate='animate'>
                <h1> Back End</h1>
                <h3> Node Js </h3>
		        <Progress done="50"/>
                <h3> Express </h3>
           ...
           <motion.div className='skills_box' variants={skillsB3Anime} initial='initial' animate='animate'>
