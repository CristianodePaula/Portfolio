...
export const navLeftAnime = {
    ...
    animate: { x: 0, opacity: 1, rotate: '270deg', transition: { duration: 3, ease: 'easeInOut' }} 
}
export const navRightAnime = {
    initial: { x: 40, opacity: 0, rotate: '90deg' },
    animate: { x: 0, opacity: 1, rotate: '90deg', transition: { duration: 3, ease: 'easeInOut' }} 
}
...
export const aboutTextAnime = {
    ...
    animate: { y: 0, opacity: 1, transition: { duration: 2, type:'spring', delay: 1.5 }}
}
export const aboutImgAnime = {
    initial: { y: -400, opacity: 0},
    animate: { y: 0, opacity: 1, transition: { duration: 4, type:'spring', delay: 1.5 }}
}
...
export const advertsGAnimation  = {
    initial: {},
    animate: {transition: { delay: 2, when: 'beforeChildren', staggerChildren: 0.5 }}
  }
...
export const skillsB1Anime = {
    ...
    animate: { y: 0, opacity: 1, scale: 1, rotate: 0, transition: {duration: 1, delay: 1, type:'spring', ease: 'easeInOut'}}
}
export const skillsB2Anime = {
    initial: { x: 100 , opacity: 0, scale: 0.1, rotate: 180 },
    animate: { x: 0, opacity: 1, scale: 1, rotate: 0, transition: {duration: 2, delay: 1, type:'spring', ease: 'easeInOut'}}
}
export const skillsB3Anime = {
    initial: { y: 100 , opacity: 0, scale: 0.1, rotate: 360 },
    animate: { y: 0, opacity: 1, scale: 1, rotate: 0, transition: {duration: 3, delay: 1, type:'spring', ease: 'easeInOut'}}
}
...
export const contactInfoAnime = {
    ...
    animate: { x: 0, opacity: 1, transition: { duration: 4, delay: 0.5, type:'spring', stiffness: 1000 }}
}
